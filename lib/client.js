...
async function apply(ctx) {
	...
	ctx.effect(() => locale.register(NS, dict), "dsh-vision-reader: dictionaries");
...
function VLProviderSection({ scope, call, t, toggleFollow }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			health ? /* @__PURE__ */ jsx("div", {
				style: styleRow,
				children: health.ok ? /* @__PURE__ */ jsx("span", {
					style: {
						...styleBadge,
			...
			models.length > 0 ? /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
				...
				}), models.map((m) => /* @__PURE__ */ jsxs("div", {
					style: {
						display: "flex",
						gap: 6,
						alignItems: "center",
					...
					children: [
						/* @__PURE__ */ jsx("span", { children: selectedModel === m.id ? "● " : "○ " }),
						/* @__PURE__ */ jsx("span", {
							style: {
								flex: 1,
								overflow: "hidden",
